...
database.execute('SELECT id, name, optimality_indx FROM RailwaySystem')

for system in database.fetchall():

    if system[2] is not None:
        print(system[1], 'already processed')
        continue
